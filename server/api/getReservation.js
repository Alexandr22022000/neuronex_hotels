    ...
    Reservation.findOne({token}, (err, reservation) => {
        ...
        Apartment.findOne({_id: reservation.apartmentId}, (err, apartment) => {
            ...
            res.status(200).send({
                ...
                start: reservation.start.getFullYear() + '.' + reservation.start.getMonth() + '.' + reservation.start.getDate(),
                end: reservation.end.getFullYear() + '.' + reservation.end.getMonth() + '.' + reservation.end.getDate(),
